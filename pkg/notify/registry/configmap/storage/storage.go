...
import (
	...
	"tkestack.io/tke/pkg/notify/registry/configmap"
...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter) *Storage {
	...
	store := &registry.Store{
		NewFunc:                  func() runtime.Object { return &notify.ConfigMap{} },
		NewListFunc:              func() runtime.Object { return &notify.ConfigMapList{} },
		DefaultQualifiedResource: notify.Resource("configmaps"),
