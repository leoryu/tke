...
import (
	...
	"tkestack.io/tke/pkg/monitor/registry/configmap"
...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter) *Storage {
	...
	store := &commonregistry.Store{
		NewFunc:                  func() runtime.Object { return &monitor.ConfigMap{} },
		NewListFunc:              func() runtime.Object { return &monitor.ConfigMapList{} },
		DefaultQualifiedResource: monitor.Resource("configmaps"),
