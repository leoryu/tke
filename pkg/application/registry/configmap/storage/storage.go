...
import (
	...
	"tkestack.io/tke/pkg/application/registry/configmap"
...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter) *Storage {
	...
	store := &registry.Store{
		NewFunc:                  func() runtime.Object { return &application.ConfigMap{} },
		NewListFunc:              func() runtime.Object { return &application.ConfigMapList{} },
		DefaultQualifiedResource: application.Resource("configmaps"),
