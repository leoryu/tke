...
import (
	...
	"tkestack.io/tke/pkg/auth/registry/configmap"
...
func NewStorage(optsGetter genericregistry.RESTOptionsGetter) *Storage {
	...
	store := &registry.Store{
		NewFunc:                  func() runtime.Object { return &auth.ConfigMap{} },
		NewListFunc:              func() runtime.Object { return &auth.ConfigMapList{} },
		DefaultQualifiedResource: auth.Resource("configmaps"),
